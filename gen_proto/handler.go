...
func generateOneHandler(gen *protogen.Plugin, file *protogen.File, handlePath string) error {
	...
	WriteLine(configFile, "// Code generated by protoc-gen-infore. DO NOT EDIT.")
	WriteLine(configFile, "// versions:")
	WriteLine(configFile, fmt.Sprintf("// - protoc-gen-infore %s", release))
	...
	for _, service := range file.Services {
		...
		if newFile {
			WriteLine(fileWriter, "// Code generated by protoc-gen-infore.")
			WriteLine(fileWriter, "// versions:")
			WriteLine(fileWriter, fmt.Sprintf("// - protoc-gen-infore %s", release))
